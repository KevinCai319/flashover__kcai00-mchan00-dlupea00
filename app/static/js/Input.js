...
export default class Input {
  ...
  mousedown() {
    localStorage.setItem("mouse", "clicked");
  }
  mouseup() {
    localStorage.setItem("mouse", "up");
  }
  mouse() {
  ...
  getMouse() {
    return new PVector(
      parseInt(localStorage.getItem("mouseX")),
      parseInt(localStorage.getItem("mouseY"))
    );
  }
  clicked() {
